// Supabase configuration (public anon key - safe for client-side)
...
// Secret keys are loaded from secrets.js (not committed to git)
// Copy secrets.example.js to secrets.js and fill in your keys
